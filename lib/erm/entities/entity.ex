defmodule Erm.Entities.Entity do
  ...
  schema "entities" do
    ...
    many_to_many :tags, Erm.Entities.Tag, join_through: Erm.Entities.EntityTags

    has_many :auths, Erm.Accounts.Authentification, foreign_key: :partner_id,
    on_delete: :delete_all

    many_to_many :roles, Erm.Authorizations.Role, join_through: Erm.Authorizations.EntityRole
